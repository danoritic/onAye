...
import 'map_page_copy_model.dart';
export 'map_page_copy_model.dart';

class MapPageCopyWidget extends StatefulWidget {
  const MapPageCopyWidget({super.key});

  @override
  State<MapPageCopyWidget> createState() => _MapPageCopyWidgetState();
}
...
class _MapPageCopyWidgetState extends State<MapPageCopyWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      setState(() {
        FFAppState().mapCurrentCoord = currentUserLocationValue;
      });
    });
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<PlacesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PlacesRecord> mapPageCopyPlacesRecordList = snapshot.data!;
                        ...
                        Align(
                          ...
                          child: PointerInterceptor(
                            ...
                            child: FlutterFlowStaticMap(
                              location: FFAppState().mapCurrentCoord!,
                              apiKey:
                                        ...
                                        return Row(
                                          ...
                                          children: List.generate(places.length,
                                            ...
                                            return TopPlaceCheckedInComponentWidget(
                                              key: Key(
                                                  'Keyaza_${placesIndex}_of_${places.length}'),
                                              place: placesItem,
                                            );
