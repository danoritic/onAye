...
import 'checkins_card_model.dart';
export 'checkins_card_model.dart';

class CheckinsCardWidget extends StatefulWidget {
  const CheckinsCardWidget({
    super.key,
  ...
  @override
  State<CheckinsCardWidget> createState() => _CheckinsCardWidgetState();
}

class _CheckinsCardWidgetState extends State<CheckinsCardWidget> {
  late CheckinsCardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CheckinsCardModel());
                                ...
                                builder: (context) {
                                  if (valueOrDefault<bool>(
                                    ...
                                    return ClipRRect(
                                      ...
                                      child: Image.network(
                                        widget.checkInDocument!.media.photoPath,
                                  ...
                                  onTap: () async {
                                    if (!_model.isLoved) {
                                      ...
                                      await userNotificationRecordReference
                                        ...
                                        isPostRenewal: false,
                                        message:
                                            'Your post at ${_model.checkinPlaceDoc?.name} was liked by ${valueOrDefault<String>(
                                          currentUserDisplayName,
                                          'Someone',
                                        )} react to their checkin photo, to chat with them privately',
                                        userThatSentMessage:
                                            currentUserReference,
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      dateTimeFormat(
                        'relative',
                        widget.checkInDocument!.dateAdded!,
